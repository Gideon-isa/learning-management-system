...
namespace Lms.Enrollment.Domain.Entities
{
    public class Student : AggregateRoot<Guid>
    {
        ...
        private Student(Guid id, string firstName, string lastName, string username) 
        { 
            Id = id;
            FirstName = firstName;
            LastName = lastName;
        ...
        public static Student Create(Guid id, string firstName, string lastName, string username)
        {
