...
namespace Lms.ContentDelivery.Domain.Entities
{
    public class CourseContent : AggregateRoot<Guid>
    {
        ...
        private CourseContent(Guid courseId, string courseTitle, string courseCode, string description, string category, Guid instructorId)
        {
            CourseId = courseId;    
        ...
        public static CourseContent Create(Guid id, string courseTitle, string courseCode, string description, string category, Guid instructorId)
        {
            ...
            return new CourseContent(id, courseTitle, courseCode, description, category, instructorId);
        }
    }
}
